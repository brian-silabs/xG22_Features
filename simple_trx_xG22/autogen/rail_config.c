 ...
 *   Radio Configurator Version: 2021.6.1
 *   RAIL Adapter Version: 2.4.15
...
const uint32_t Protocol_Configuration_modemConfigBase[] = {
  ...
  /*    40E4 */ 0x00000000UL,
  0x010140ECUL, 0x8C84B89BUL,
  0x010540F4UL, 0x07830464UL,
  /*    40F8 */ 0x3AC81388UL,
  /*    40FC */ 0x000A209CUL,
  /*    4100 */ 0x00206100UL,
  /*    4104 */ 0x123556B7UL,
  0x0103410CUL, 0x0011F778UL,
  /*    4110 */ 0x29043020UL,
  /*    4114 */ 0x4040BB88UL,
